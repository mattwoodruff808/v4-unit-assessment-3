...
class Player extends Character {
  ...
  defend(amount){
    let remainingHealth = this.healthLevel -= amount;

    if (this.healthLevel > 0){
      return {attackStrength: amount, remainingHealth: remainingHealth, message: `${this.name} is still in the fight!`}
    } else {
...
fireSpitter.addSuperPower('strength');
